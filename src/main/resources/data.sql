...
INSERT INTO LOAN (USER_ID,BOOK_ID) VALUES((SELECT USER_ID FROM USER u WHERE u.EMAIL = 'ldenda@live.com.au'),(SELECT BOOK_ID FROM BOOK b WHERE b.ISBN = '6323424632'));
INSERT INTO LOAN (USER_ID,BOOK_ID) VALUES((SELECT USER_ID FROM USER u WHERE u.EMAIL = 'kwalter@live.com.au'),(SELECT BOOK_ID FROM BOOK b WHERE b.ISBN = '3525234124'));